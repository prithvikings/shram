...
const WhatWeDo = () => {
  return (
    <div className="max-w-6xl mx-auto border-x border-b border-zinc-200 bg-white font-sans">
      {/* Top Header Bar */}
      <div className="flex justify-between items-center px-8 py-4 border-b border-t border-zinc-200 text-xs font-mono text-zinc-500 tracking-widest uppercase">
        <div>WHAT WE DO</div>
        <div>[1/8]</div>
      </div>
